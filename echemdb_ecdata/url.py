...
def get_echemdb_database_url(version="0.8.3"):
    ...
    By default a URL is returned with the most recent version::
        ...
        'https://github.com/echemdb/electrochemistry-data/releases/download/0.8.3/data-0.8.3.zip'

    A URL with a specific version can be created::

        >>> from echemdb_ecdata.url import get_echemdb_database_url
        >>> get_echemdb_database_url(version="0.8.3")
        'https://github.com/echemdb/electrochemistry-data/releases/download/0.8.3/data-0.8.3.zip'
